...
setup(
    ...
    data_files=[
        ...
        (os.path.join(share_dir, 'models'), ['models/kr20_kr120.sdf', 'models/model.config']),
        (os.path.join(share_dir, 'models', 'collision'), glob('models/collision/*')),
        (os.path.join(share_dir, 'models', 'visual'), glob('models/visual/*')),
        (os.path.join(share_dir, 'models', 'urdf'), glob('models/urdf/*')),
    ],
